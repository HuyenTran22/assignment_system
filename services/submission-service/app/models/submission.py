...
class Submission(Base):
    ...
    status = Column(SQLEnum(SubmissionStatus), nullable=False, index=True)
    comment = Column(Text)
    ...
    # Note: rubric_scores, peer_reviews relationships removed - these models are in other services
